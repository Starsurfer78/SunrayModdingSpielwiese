...
#define DOCKSPEED                   0.60
#define DOCKPATHSPEED               0.30
...
#define ROTATION_RAMP_MAX           95    // (deg/s) maximum rotation speed
...
#define DOCK_POINT_GPS_REBOOT       3     // 
#define DOCK_SLOW_ONLY_LAST_POINTS  3     //
#define DOCK_REVERSE_POINT          3
